              ...
              <div class="form-group">
                ...
                <select class="form-control" id="parking_slot" name="parking_slot">
                  ...
                  <?php // foreach ($slot_data as $k => $v) : ?>
                    <option value="<?php // echo $v['id'] ?>" <?php // if ($save_parking_data['slot_id'] == $v['id']) { echo "selected";  } ?>><?php // echo $v['slot_name']; ?></option>
                  <?php // endforeach ?>
                </select>
              </div>
              <div class="form-group">
                ...
                <select class="form-control" id="vehicle_cat" name="vehicle_cat">
                  ...
                  <?php // foreach ($vehicle_cat as $k => $v) : ?>
                    <option value="<?php // echo $v['id'] ?>" <?php // if ($save_parking_data['vechile_cat_id'] == $v['id']) {   echo "selected"; } ?>><?php // echo $v['name'] ?></option>
                  <?php // endforeach ?>
                </select>
              </div>
              <div class="form-group">
