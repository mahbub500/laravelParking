      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview" id="categorySideTree">
          ...
          <ul class="treeview-menu">
            ...
            <li id="createCategorySideTree"><a href="{{url('/category/create')}}"><i class="fa fa-arrow-circle-right"></i> Add Category</a></li>
            <?php  //endif; ?>
            ...
            <li id="manageCategorySideTree"><a href="{{url('/category')}}"><i class="fa fa-arrow-circle-right"></i> Manage Category</a></li>
            <?php  //endif; ?>
          </ul>
        </li>
      <?php  //endif; ?>
        ...
        <li class="treeview" id="slotsSideTree">
          ...
          <ul class="treeview-menu">
            <?php  //if(in_array('createSlots', $user_permission)): ?>
              <li id="createSlotsSideTree"><a href="{{url('/slot/create')}} "><i class="fa fa-arrow-circle-right"></i> Add Slot</a></li>
            <?php  //endif; ?>
            <?php  //if(in_array('updateSlots', $user_permission) || in_array('viewSlots', $user_permission) || in_array('deleteSlots', $user_permission)): ?>
            <li id="manageSlotsSideTree"><a href="{{url('/slot')}}"><i class="fa fa-arrow-circle-right"></i> Manage Slot</a></li>
            <?php  //endif; ?>
          </ul>
        </li>
      <?php  //endif; ?>
