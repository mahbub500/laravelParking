              ...
              <form role="form" action="/category/{{$category->id}}" method="post">
                ...
                <div class="box-body"> 
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="category_name" value="{{$category->category_name}}" name="category_name" placeholder="Category name" >
                  </div>                
                  
                  <div class="form-group">
                    <label for="category_active">Status</label>
                    <select type="text" class="form-control" id="category_active" name="category_active">
                      {{-- {{$company->shopping_id == $shopping->id  ? 'selected' : ''}} --}}
